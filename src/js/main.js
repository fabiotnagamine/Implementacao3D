...
import moon from '../img/lua.jpg';
import galaxy from '../img/galaxia.jpeg';
import sun from '../img/sol.jpeg'; 
import earth from '../img/earth.jpeg';

const textureLoader = new THREE.TextureLoader();

const model1 = new URL('../assets/scene (1).gltf', import.meta.url);
const model2 = new URL('../assets/model.gltf', import.meta.url);
...
const box2MultiMaterial = [
    new THREE.MeshBasicMaterial({map: textureLoader.load(earth)}),
...
let mixer;
assetLoader.load(model1.href, function(gltf) {
